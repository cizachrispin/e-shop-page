                ...
                <form method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <img src="../images/admin_images/<?php echo $admin_image; ?>" alt="<?php echo $admin_name; ?>" width="70" height="70">
...
if(isset($_POST['update'])){
    ...
    move_uploaded_file($temp_admin_image,"../images/admin_images/$user_image");
